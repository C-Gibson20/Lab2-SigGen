...
class Vsinegen___024root final : public VerilatedModule {
  public:
    ...
    VL_IN8(rst,0,0);
    VL_IN8(en,0,0);
    VL_IN8(phase_diff,0,0);
    VL_OUT8(dout1,7,0);
    VL_OUT8(dout2,7,0);
    CData/*7:0*/ sinegen__DOT__count1;
    CData/*7:0*/ sinegen__DOT__count2;
    CData/*7:0*/ __Vdly__sinegen__DOT__count1;
    CData/*0:0*/ __Vclklast__TOP__clk;
    CData/*0:0*/ __Vclklast__TOP__rst;
    VlUnpacked<CData/*7:0*/, 256> sinegen__DOT__myDualRom__DOT__rom_array;
