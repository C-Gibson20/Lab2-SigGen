...
VL_ATTR_COLD void Vsigdelay___024root__trace_init_sub__TOP__0(Vsigdelay___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+5,"offset", false,-1);
    tracep->declBit(c+6,"mic_signal", false,-1);
    ...
    tracep->declBit(c+5,"diff", false,-1);
    tracep->declBus(c+8,"count1", false,-1, 7,0);
    tracep->declBus(c+9,"count2", false,-1, 7,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("myDualRam ");
...
VL_ATTR_COLD void Vsigdelay___024root__trace_full_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+5,(vlSelf->offset));
    bufp->fullBit(oldp+6,(vlSelf->mic_signal));
    bufp->fullCData(oldp+7,(vlSelf->delayed_signal),8);
    bufp->fullCData(oldp+8,(vlSelf->sinegen__DOT__count1),8);
    bufp->fullCData(oldp+9,(vlSelf->sinegen__DOT__count2),8);
