...
void Vsigdelay___024root__trace_chg_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+4,(vlSelf->offset));
    bufp->chgBit(oldp+5,(vlSelf->mic_signal));
    bufp->chgCData(oldp+6,(vlSelf->delayed_signal),8);
    bufp->chgCData(oldp+7,(vlSelf->sinegen__DOT__count1),8);
    bufp->chgCData(oldp+8,(vlSelf->sinegen__DOT__count2),8);
